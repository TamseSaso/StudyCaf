  ...
  <div class="Body w-full p-0 md:p-[25px] bg-black rounded-[70px] flex flex-col justify-start items-center">
    <div id="header-placeholder" class="w-full mb-0 md:mb-[30px]">
      ...
      <div class="NewProduct w-full md:w-full h-[700px] px-4 md:px-20 py-[57px] bg-[#f9d4b3] rounded-[32px] md:rounded-[70px] flex flex-col justify-start items-start gap-2.5">
          <form action="edit_category_site2.php" method="GET" class="Form w-full md:w-auto flex flex-col justify-start items-start gap-2.5">
                <div class="BestCoffeeRoasted text-[#333333] text-7xl font-bold font-['Red Rose'] leading-[80px]">EDIT<br/>CATEGORY</div>
                ...
                <select name="category" class="custom-select text-[#333333] Rectangle max-w-[340px] w-full md:w-[200px] h-12 pl-[24px] top-[28px] absolute bg-white rounded-3xl appearance-none" required>
